...
raise('I18n::Rails::TranslationHelper requires i18n >= 0.5.0 and action_pack >= 3.0.0') unless I18n::VERSION >= '0.5.0' && ActionPack::VERSION::MAJOR >= 3

module I18n
  class ExceptionHandler
    # include an anonymous module to make sure html formatted error messages
...
if defined?(ActionView::Helpers::TranslationHelper)
  ActionView::Helpers::TranslationHelper.send(:remove_method, :t, :translate, :l, :localize, :scope_key_by_partial, :html_safe_translation_key?)
  ActionView::Helpers.send(:include, I18n::Rails::TranslationHelper)
end
