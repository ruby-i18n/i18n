...
class I18nBackendExceptionsTest < Test::Unit::TestCase
  ...
  define_method "test exceptions: MissingTranslationData message from #translate includes the given scope and full key" do
    begin
  ...
  define_method "test exceptions: MissingTranslationData message from #localize includes the given scope and full key" do
    begin
